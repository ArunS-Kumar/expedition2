...
<html>
  <head>
    ...
    <title>Tourism | <?php if($page_title <>'') echo $page_title; ?></title>
    ...
    <link href="https://adminlte.io/themes/AdminLTE/dist/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
  ...
  <body class="hold-transition skin-blue layout-top-nav">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <img src="<?php echo base_url('/assets/images/logo.png'); ?>" alt="Cinebels" style="width: 71%;ma;margin-top: -4%;float: left;" >
                  ...
                  <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="user-header">
                        <img src="<?php echo base_url(); ?>assets/images/logo.png" class="img-circle" alt="User Image" style="width: 260px;height: 70px;margin-bottom: 15px;margin-top: 10px;border-radius: 0;">
                        <p>
   ...
   <?php } else { ?>
        ...
        <div class="login-box">
        <div class="login-logo" style="background-color: #999; height: 140px;" >
        <a href="javascript:;">
        <img src="<?php echo base_url('assets/images/logo.png')?>" alt="cinebels" width="100%" style=" margin-top: 50px; width: 320px; ">
