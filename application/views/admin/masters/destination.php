             ...
             <div class="box">
                ...
                <div class="box-header with-border">
                  ...
                  <option value="100">100</option>
                   ...
                   <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/destination/form'); ?>" style="float: left;">
                ...
                <div class="box-body table-responsive" id="box-bodyss">
                  ...
                  <thead>
                    ...
                    if(!empty($destination)) { foreach($destination as $appltn) { ?>
                    ...
                    <tr id="serial-<?php echo $appltn->id; ?>">
                      ...
                      <td class="center">
                          ...
                          <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/destination/form/'.$appltn->id); ?>">
...
<script>
    $(document).ready(function() {
	    ...
	    function fnParent() {
            ...
            $.post("<?php echo base_url(); ?>admin/destination", {
        ...
        // Deactive Script //
         $( ".deactive_active" ).click(function() {
            ...
            $.post("<?php echo base_url(); ?>admin/destination/activate_dactivate", {
                id: id
            }, function (data) {
                if(data == 1) {
                    $("#overlay2"+id).show();
...
{
	$.ajax({
		url:"<?php echo base_url();?>admin/destination/get_serial",
		type:'POST',
