             ...
             <div class="box">
                ...
                <div class="box-header with-border">
                  ...
                  <option value="100">100</option>
                   ...
                   <a class="various"  href="<?php echo base_url('admin/pages/form'); ?>" style="float: left;">
                  ...
                  <thead>
                    ...
                    <tr id="serial-<?php echo $appltn->id; ?>">
                      ...
                      <td class="center">
                          ...
                          <a class="various"  href="<?php echo base_url('admin/pages/form/'.$appltn->id); ?>">
...
<script>
    $(document).ready(function() {
	    ...
	    function fnParent() {
            ...
            $.post("<?php echo base_url(); ?>admin/pages", {
        ...
        // Deactive Script //
         $( ".deactive_active" ).click(function() {
            ...
            $.post("<?php echo base_url(); ?>admin/pages/activate_dactivate", {
                id: id
            }, function (data) {
                if(data == 1) {
                    $("#overlay2"+id).show();
