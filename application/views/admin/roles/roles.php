            ...
            <div class="col-xs-12">
             <div class="box">
                ...
                <div class="box-header with-border">
                 ...
                 <!--  <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/roles/form'); ?>" style="float: left;">
                  ...
                  <thead>
                    ...
                    <tr id="serial-<?php echo $categy->id; ?>">
                     ...
                     <!-- <td class="center">
                          ...
                          <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/roles/form/'.$categy->id); ?>">
...
<script>
    $(document).ready(function() {
	    ...
	    function fnParent() {
            ...
            $.post("<?php echo base_url(); ?>admin/roles", {
        ...
        // Deactive Script //
         $( ".deactive_active" ).click(function() {
            ...
            $.post("<?php echo base_url(); ?>admin/roles/activate_dactivate", {
                id: id
            }, function (data) {
                if(data == 1) {
                    $("#overlay2"+id).show();
...
{
	$.ajax({
		url:"<?php echo base_url();?>admin/roles/get_serial",
		type:'POST',
