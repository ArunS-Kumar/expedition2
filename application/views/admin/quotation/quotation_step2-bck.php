    ...
    <div class="container">
            ...
            <li class="groupmenu">
                ...
                <ul class="tree-branch adds ">
                    ...
                    <li data-location="<?php echo $list['id'].'-'.$slist['id']; ?>" class="groupmenu">
                        ...
                        <ul class="tree-branchs tree2 adds">
                            ...
                            <li data-location="<?php echo $vals['qpid']?>">
                                ...
                                <span class="lititles">-&nbsp;&nbsp;<?php echo $vals['pname'].', QTY - '.$vals['qty']; ?></span>
        ...
        <div class="overlay overlayss" style="display:none;">
            ...
            <div class="dataTables_length" id="example1_length" style="float: left; margin-right: 1%;">
                <select name="example1_length" aria-controls="example1" class="form-control input-sm controlss" id="tablelimit" name="tablelimit">
            ...
            <div class="dataTables_length" id="example1_length" style="float: left; margin-right: 1%;">
                <select name="example1_length" aria-controls="example1" class="form-control input-sm head_lenth controlss" id="brand" name="brand">
            ...
            <div class="dataTables_length" id="example1_length" style="float: left; margin-right: 1%;">
                <select name="example1_length" aria-controls="example1" class="form-control input-sm head_lenth controlss" id="series" name="series">
            ...
            <div class="dataTables_length" id="example1_length" style="float: left; margin-right: 1%;">
                <select name="example1_length" aria-controls="example1" class="form-control input-sm head_lenth controlss" id="category" name="category">
            ...
            <div class="dataTables_length" id="example1_length" style="float: left; margin-right: 1%;">
                <select name="example1_length" aria-controls="example1" class="form-control input-sm head_lenth controlss" id="subcategory" name="subcategory">
...
The great content goes here
    ...
    <!-- 
    <a href="<?php echo base_url('admin/quotation/generate_pdf'); ?>">
    <button type="button" class="btn btn-success btn-sm" data-widget="pdf" data-toggle="tooltip" title="" data-original-title="pdf">
    ...
    <i class="fa fa-fw fa-file-text-o"></i>NEXT
    </button></a> 
                                        <!-- /.box-body -->
                                    </div>
                                    <!-- /.box -->
