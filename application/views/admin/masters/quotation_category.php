             ...
             <div class="box">
                ...
                <div class="box-header with-border">
                  ...
                  <option value="100">100</option>
                   ...
                   <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/quotation_category/form'); ?>" style="float: left;">
                ...
                <div class="box-body table-responsive" id="box-bodyss">
                  ...
                  <thead>
                    ...
                    if(!empty($category)) { foreach($category as $categy) { 
                        if($categy->parent_id) { 
                            $main_val = $this->Quotation_category_model->get_category($categy->parent_id); 
                            $parent = 'Sub Category of <a class="various" data-fancybox-type="iframe" href="'.base_url().'admin/quotation_category/form/'.$categy->parent_id.'">'.$main_val->name.'</a>';
                        } else { 
                    ...
                    <tr id="serial-<?php echo $categy->id; ?>">
                      ...
                      <td class="center">
                          ...
                          <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/quotation_category/form/'.$categy->id); ?>">
...
<script>
    $(document).ready(function() {
	    ...
	    function fnParent() {
            ...
            $.post("<?php echo base_url(); ?>admin/quotation_category", {
        ...
        // Deactive Script //
         $( ".deactive_active" ).click(function() {
            ...
            $.post("<?php echo base_url(); ?>admin/quotation_category/activate_dactivate", {
                id: id
            }, function (data) {
                if(data == 1) {
                    $("#overlay2"+id).show();
...
{
	$.ajax({
		url:"<?php echo base_url();?>admin/quotation_category/get_serial",
		type:'POST',
