                    ...
                    <div class="box ">
                       <!--  <div class="box-header with-border">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="false">Tours Info</a></li>
                            <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">Tours Images</a></li>
                            <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="true">Tours Days</a></li>
                        </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_1">
                                    <div class="box-body">
                                        ...
                                        <div class="col-xs-11">
                                            <label for="exampleInputEmail1">Tour Description</label>
                                ...
                                <div class="tab-pane" id="tab_3">
                                    ...
                                    <div class="col-xs-11">
                                        ...
                                        <select name="days" class="form-control" style="width: 10%;" id="day_select">
                                    ...
                                    foreach ($day_values as $key => $value) { ?>
                                        ...
                                        <input type="text" class="form-control valid" id="" placeholder="Video Url" name="day_values[<?php echo $i;?>][url]" value="<?php echo $value->url ?>" aria-required="true" aria-invalid="false"><br>
