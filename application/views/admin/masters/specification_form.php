            ...
            <div class="col-xs-12">
             ...
             <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title"> <i class="fa fa-fw fa-plus"></i> Specification</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo base_url('admin/specification/form/'.$id);?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="cont_enquiry">
                  <div class="box-body">
                  
                    <div style="float: left;width: 100%;margin-top: 2%;">
                    <div class="col-xs-11">
                        <select class="form-control valid" name="category_id" aria-invalid="false">
                        <option value="" disabled selected>Select Category ..</option>
                        <?php if(!empty($category_list)) { foreach($category_list as $list) {  ?>
                        <option value="<?php echo $list['id']; ?>" <?php if(!empty($category_id) && $category_id == $list['id']) echo 'selected'; ?>><?php echo $list['name']; ?></option>
                        <?php } } ?>
                        </select>
                    </div>
                    </br>
