            ...
            <div class="col-xs-12">
             ...
             <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title"> <i class="fa fa-fw fa-plus"></i> Quotation Category</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo base_url('admin/quotation_category/form/'.$id);?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="cont_enquiry">
                  <div class="box-body">
                    ...
                    <select class="form-control" name="parent_id">
                        ...
                        <?php if(!empty($parent_list)) { foreach($parent_list as $list) { if($id <> $list['id']) { ?>
                        <option value="<?php echo $list['id']; ?>" <?php if(!empty($parent_id) && $parent_id == $list['id']) echo 'selected'; ?>><?php echo $list['name']; ?></option>
                        <?php } } } ?>
                      </select>
                      </div>
                      </br>
                      ...
                      <select class="form-control" name="application_id">
                        ...
                        <option value="<?php echo $list['id']; ?>" <?php if(!empty($application_id) && $application_id == $list['id']) echo 'selected'; ?>><?php echo $list['name']; ?></option>
                        <?php } } ?>
                      </select>
                      </div>
                    </div>
