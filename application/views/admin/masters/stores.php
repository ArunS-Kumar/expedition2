             ...
             <div class="box">
                ...
                <div class="box-header with-border">
                  ...
                  <option value="100">100</option>
                   ...
                   <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/stores/form'); ?>" style="float: left;">
                ...
                <div class="box-body table-responsive" id="box-bodyss">
                  ...
                  <thead>
                    ...
                    if(!empty($stores)) { foreach($stores as $strs) { ?>
                    ...
                    <tr id="serial-<?php echo $strs->id; ?>">
                      ...
                      <td class="center">
                          ...
                          <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/stores/form/'.$strs->id); ?>">
...
<script>
    $(document).ready(function() {
	    ...
	    function fnParent() {
            ...
            $.post("<?php echo base_url(); ?>admin/stores", {
        ...
        // Deactive Script //
         $( ".deactive_active" ).click(function() {
            ...
            $.post("<?php echo base_url(); ?>admin/stores/activate_dactivate", {
                id: id
            }, function (data) {
                if(data == 1) {
                    $("#overlay2"+id).show();
...
{
	$.ajax({
		url:"<?php echo base_url();?>admin/stores/get_serial",
		type:'POST',
