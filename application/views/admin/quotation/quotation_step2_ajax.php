                  ...
                  <thead>
                    ...
                    <tr>
                      ...
                      <td class="vcenter"> 
                            ...
                            <select name="example1_length" aria-controls="example1" class="form-control input-sm head_lenth" id="finish<?php echo $quttn['id']; ?>">
            ...
            if(group != '')
            {
                if(finish != '' && qty != '')
                {
                    ...
                    $.post('<?php echo base_url("admin/quotation/quotation_product");?>', {
                        ...
                        $(".makesels-"+group).addClass("selected");
                    });
