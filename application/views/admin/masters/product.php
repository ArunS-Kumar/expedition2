             ...
             <div class="box">
                ...
                <div class="box-header with-border">
                  ...
                  <option value="100">100</option>
                   ...
                   <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/product/form'); ?>" style="float: left;">
                ...
                <div class="box-body table-responsive" id="box-bodyss">
                  ...
                  <thead>
                    ...
                    <?php 
                    $i=1; 
                    if(!empty($product)) { foreach($product as $strs) { ?>
                    
                    <tr id="serial-<?php echo $strs->id; ?>">
                      <td><a href="javascript:;"><span class="handle ui-sortable-handle">
                                <i class="fa fa-ellipsis-v"></i>
                                <i class="fa fa-ellipsis-v"></i>
                            </span></a></td>
                            
                      <td><?php echo $strs->product_id; ?></td>
                      <td><?php echo $strs->name; ?></td>
                      <td><?php echo $strs->model_name; ?></td>
                      <td><?php echo $strs->price; ?></td>
                      
                      <td> <div class="actv<?php echo $strs->id; ?>"> <?php if($strs->enabled == 1) echo "Yes"; else echo "No"; ?> </div></td>
                      <td class="center">
                      
                          <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/product/form/'.$strs->id); ?>">
                          ...
                          <button class="btn btn-default btn-sm deactive_active" data-widget="Active" data-toggle="tooltip" title="" data-original-title="Active" id="overlay1<?php echo $strs->id; ?>" value="<?php echo $strs->id; ?>" <?php if(!empty($strs->enabled)) echo 'style="display:none;"'; ?>><i class="icon fa fa-check"></i></button>
                          
                          <button class="btn btn-default btn-sm deactive_active" data-widget="Deactive" data-toggle="tooltip" title="" data-original-title="Deactive" id="overlay2<?php echo $strs->id; ?>" value="<?php echo $strs->id; ?>" <?php if(empty($strs->enabled)) echo 'style="display:none;"'; ?>><i class="fa fa-fw fa-times"></i></button>
...
<script>
    $(document).ready(function() {
	    ...
	    function fnParent() {
            ...
            $.post("<?php echo base_url(); ?>admin/product", {
        ...
        // Deactive Script //
         $( ".deactive_active" ).click(function() {
            ...
            $.post("<?php echo base_url(); ?>admin/product/activate_dactivate", {
                id: id
            }, function (data) {
                if(data == 1) {
                    $("#overlay2"+id).show();
...
{
	$.ajax({
		url:"<?php echo base_url();?>admin/product/get_serial",
		type:'POST',
