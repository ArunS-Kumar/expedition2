...
The great content goes here
    ...
    <button type="button" class="btn btn-info btn-danger"><i class="fa fa-fw fa-arrow-left"></i>&nbsp;Back</button></a>
    
    <a href="<?php echo base_url('admin/quotation/preview'); ?>">
    <button type="button" class="btn btn-success btn-sm"> Next&nbsp;<i class="fa fa-fw fa-arrow-right"></i></button></a>
