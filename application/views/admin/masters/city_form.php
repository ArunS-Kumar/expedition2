            ...
            <div class="col-xs-12">
             ...
             <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title"> <i class="fa fa-fw fa-plus"></i> Cities</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo base_url('admin/city/form/'.$id);?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="cont_enquiry">
                  <div class="box-body">
                    ...
                    <div class="col-xs-11">
                        <select class="form-control valid" name="state_id" aria-invalid="false" required>
                        <option value="" disabled selected>Select State ..</option>
                        <?php if(!empty($state_list)) { foreach($state_list as $list) {  ?>
                        <option value="<?php echo $list['stateID']; ?>" <?php if(!empty($state_id) && $state_id == $list['stateID']) echo 'selected'; ?>><?php echo $list['stateName']; ?></option>
                        <?php } } ?>
                        </select>
                    </div>
                    </br>
