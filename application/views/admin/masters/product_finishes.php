             ...
             <div class="box">
                ...
                <div class="box-header with-border">
                  ...
                  <option value="100">100</option>
                   ...
                   <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/product_finishes/form'); ?>" style="float: left;">
                ...
                <div class="box-body table-responsive" id="box-bodyss">
                  ...
                  <thead>
                    ...
                    if(!empty($product_finishes)) { foreach($product_finishes as $finishes) { ?>
                    
                    <tr id="serial-<?php echo $finishes->id; ?>">
                      <td><a href="javascript:;"><span class="handle ui-sortable-handle">
                                <i class="fa fa-ellipsis-v"></i>
                                <i class="fa fa-ellipsis-v"></i>
                            </span></a></td>
                      <td><?php echo $finishes->name; ?></td>
                      <td> <div class="actv<?php echo $finishes->id; ?>"> <?php if($finishes->enabled == 1) echo "Yes"; else echo "No"; ?> </div></td>
                      <td class="center">
                      
                          <a class="various" data-fancybox-type="iframe" href="<?php echo base_url('admin/product_finishes/form/'.$finishes->id); ?>">
                          ...
                          <button class="btn btn-default btn-sm deactive_active" data-widget="Active" data-toggle="tooltip" title="" data-original-title="Active" id="overlay1<?php echo $finishes->id; ?>" value="<?php echo $finishes->id; ?>" <?php if(!empty($finishes->enabled)) echo 'style="display:none;"'; ?>><i class="icon fa fa-check"></i></button>
                          
                          <button class="btn btn-default btn-sm deactive_active" data-widget="Deactive" data-toggle="tooltip" title="" data-original-title="Deactive" id="overlay2<?php echo $finishes->id; ?>" value="<?php echo $finishes->id; ?>" <?php if(empty($finishes->enabled)) echo 'style="display:none;"'; ?>><i class="fa fa-fw fa-times"></i></button>
...
<script>
    $(document).ready(function() {
	    ...
	    function fnParent() {
            ...
            $.post("<?php echo base_url(); ?>admin/product_finishes", {
        ...
        // Deactive Script //
         $( ".deactive_active" ).click(function() {
            ...
            $.post("<?php echo base_url(); ?>admin/product_finishes/activate_dactivate", {
                id: id
            }, function (data) {
                if(data == 1) {
                    $("#overlay2"+id).show();
...
{
	$.ajax({
		url:"<?php echo base_url();?>admin/product_finishes/get_serial",
		type:'POST',
