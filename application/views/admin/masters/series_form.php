            ...
            <div class="col-xs-12">
             ...
             <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title"> <i class="fa fa-fw fa-plus"></i> Series</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo base_url('admin/series/form/'.$id);?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="cont_enquiry">
                  <div class="box-body">
                  
                    <div style="float: left;width: 100%;margin-top: 2%;">
                    <div class="col-xs-11">
                        <select class="form-control valid" name="brand_id" aria-invalid="false">
                        <option value="" disabled selected>Select Brand ..</option>
                        <?php if(!empty($brand_list)) { foreach($brand_list as $list) {  ?>
                        <option value="<?php echo $list['id']; ?>" <?php if(!empty($brand_id) && $brand_id == $list['id']) echo 'selected'; ?>><?php echo $list['name']; ?></option>
                        <?php } } ?>
                        </select>
                    </div>
                    </br>
